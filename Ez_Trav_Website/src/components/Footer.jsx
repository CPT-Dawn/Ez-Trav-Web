...
const Footer = () => {
  const socialLinks = [
    { icon: <FaYoutube />, link: 'https://www.youtube.com/channel/UCw-Rb6RBJNqzLDhpB-ZdE3Q', label: 'YouTube' },
    { icon: <FaSpotify />, link: 'https://open.spotify.com/artist/7oWuvB2J1W94Y9M8jiPneB?si=vnOoBEeFTB6oMzSk6XARgQ&utm_medium=share&utm_source=linktree&nd=1&dlsi=024eb94e3bf44538', label: 'Spotify' },
    { icon: <FaInstagram />, link: 'https://www.instagram.com/at17music/', label: 'Instagram' },
    { icon: <FaLinkedinIn />, link: 'https://www.linkedin.com/in/alok-tiwari-13831b250/', label: 'LinkedIn' },
  ];
