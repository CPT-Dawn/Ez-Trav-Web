...
import backgroundImage from './BG.png'; // Update this with your image path
...
const Homepage = () => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="relative w-full h-screen" // Full width and height of the viewport
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 bg-black opacity-40 z-0"></div> {/* Apply dark opacity only on the background */}

      {/* Content */}
      <motion.div className="relative z-10 container mx-auto px-4 py-8">
        {/* Hero Section */}
        <motion.section
        ...
        {/* Features */}
        <section className="z-10 px-4 py-8 md:px-8 md:py-12">
